...
import { createStockTransfer, getMyOwnTransferLogs, getStockTransferById, getStockTransferLogs, updateStockTransferLogStatus } from "../controllers/stockTransferController";
...
router.get(
    ...
    authenticate,
    authorizePermission(PERMISSIONS.STOCK_DISTRIBUTION_HISTORY_VIEW_ALL),
...
router.get(
    ...
    createRateLimiter(5 * 60 * 1000, 100),
    authenticate,
    hasAnyPermission(PERMISSIONS.STOCK_DISTRIBUTION_HISTORY_VIEW_OWN, PERMISSIONS.STOCK_DISTRIBUTION_HISTORY_VIEW_ALL),
    getMyOwnTransferLogs
)
