...
import distributorNotificationEvents from "../events/distributorNotification.events";
dotenv.config();

export let distributorNotificationNamespace: Namespace;

export function initDistributorNotificationNamespace(io: SocketIOServer): void {
    ...
    socketConnection({
        ...
        events: distributorNotificationEvents(distributorNotificationNamespace)
    })
}
